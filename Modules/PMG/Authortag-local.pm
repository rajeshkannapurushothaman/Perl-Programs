...
my $Agivenname = "([A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.|[A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.|[A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.|[A-Z]\\.\\-?\\s*[A-Z]\\.|[A-Z]\\. [A-Z]\\.|[A-Z]\\.\\s*\\-?[A-Z]\\.|[A-Z]\\.\\-?\\s*[A-Z]\b|[A-Z]\\.\\s*\\-?[A-Z]\b|[A-Z]\-?[A-Z]\\.|[A-Z] [A-Z]\\.|[A-Z]\-[A-Z]|[A-Z] [A-Z]|[A-Z]\\-[A-Z][A-Z]\\.|[A-Z]\\-[A-Z][A-Z]|[A-Z][A-Z][A-Z]|[A-Z][A-Z]|[A-Z]\\.|[A-Z])";
...
my $givenname = "([A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.|[A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.|[A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.|[A-Z]\\-[A-Z][A-Z]\\.|[A-Z]\\.\\-?\\s*[A-Z]\\.|[A-Z]\\. [A-Z]\\.|[A-Z] [A-Z]\\.|[A-Z]\\.\\s*\\-?[A-Z]\\.|[A-Z]\-?[A-Z]\\.|[A-Z]\\.\\-?\\s*[A-Z]|[A-Z] [A-Z]\\.|[A-Z]\-[A-Z]|[A-Z] [A-Z]|[A-Z][A-Z]|[A-Z]\\.|[A-Z])";
...
sub nameConvert
{
    ...
    if ($line =~ m/<Authorgroup>(.*?)<\/Authorgroup>/ && $line !~ m/<Surname>/) {
      ...
      if ($authorgroup =~ m/^$surname\, $givenname$/) {
        ...
        $authorgroup =~ s/(.*)/<Collab>$1<\/Collab>/;
      } elsif ($authorgroup =~ m/^($surname\, $givenname[\,\;] |[A-Z]\-[A-Z][a-z]+\-[A-Z][a-z]+\, $givenname[\,\;] |$surname\,? $suffix\, $givenname\, |$surname\,? $suffix\, $givenname|$surname\, $givenname&comma; $suffix\, )/) {
        my $temp = '';
