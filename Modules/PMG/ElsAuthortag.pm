...
my $Agivenname = "([A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.|[A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.|[A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.|[A-Z]\\.\\-?\\s*[A-Z]\\.|[A-Z]\\. [A-Z]\\.|[A-Z]\\.\\s*\\-?[A-Z]\\.|[A-Z]\\.\\-?\\s*[A-Z]|[A-Z]\\.\\s*\\-?[A-Z]|[A-Z]\-?[A-Z]\\.|[A-Z] [A-Z]\\.|[A-Z]\-[A-Z]|[A-Z] [A-Z]|[A-Z]\\-[A-Z][A-Z]|[A-Z][A-Z][A-Z]|[A-Z][A-Z]|[A-Z]\\.|[A-Z])";
...
my $givenname = "([A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.|[A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.|[A-Z]\\.\\-?\\s*[A-Z]\\.\\-?\\s*[A-Z]\\.|[A-Z]\\.\\-?\\s*[A-Z]\\.|[A-Z]\\. [A-Z]\\.|[A-Z] [A-Z]\\.|[A-Z]\\.\\s*\\-?[A-Z]\\.|[A-Z]\-?[A-Z]\\.|[A-Z]\\.\\-?\\s*[A-Z]|[A-Z] [A-Z]\\.|[A-Z]\-[A-Z]|[A-Z] [A-Z]|[A-Z][A-Z]|[A-Z]\\.|[A-Z])";

my $suffix = "(Jr\\.?|Sr\\.?|II\\.?|III\\.?|IV\\.?|V\\.?|VI\\.?|VII\\.?)";
...
#		}
      ...
      $line =~ s/^($surname\,? $Agivenname\,?)( <em>)/<Authorgroup>$1<\/Authorgroup>$4/;
    } elsif($line =~ s/^((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+ (?:[A-Z]\.|[A-Z]\.\-[A-Z]\.|[A-Z]\.[A-Z]\.))\, ([A-Z][a-z]+ (?:[A-Z]\.|[A-Z]\.\-[A-Z]\.|[A-Z]\.[A-Z]\.)) ((?:Mc|Mac)?[A-Z][a-z]+)(\, and )([A-Z][a-z]+ (?:[A-Z]\.|[A-Z]\.\-[A-Z]\.|[A-Z]\.[A-Z]\.)) ((?:Mc|Mac)?[A-Z][a-z]+)(\,? )/<Authorgroup><author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author>\, <author><Forename>$3<\/Forename> <Surname>$4<\/Surname><\/author>$5<author><Forename>$6<\/Forename> <Surname>$7<\/Surname><\/author><\/Authorgroup>$8/) {
    	print "Author Count 3\n" if ($debug);
    	
  	  print "SNM FullGNM GNM., FullGNM GNM. SNM, and FullGNM GNM. SNM\n" if ($debug);
    } elsif($line =~ s/^((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+)\, ([A-Z][a-z]+ $Agivenname) ((?:Mc|Mac)?[A-Z][a-z]+)(\,? and )([A-Z][a-z]+\-[A-Z][a-z]+) ([A-Z][a-z]+)(\,? )/<Authorgroup><author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author>\, <author><Forename>$3<\/Forename> <Surname>$5<\/Surname><\/author>$6<author><Forename>$7<\/Forename> <Surname>$8<\/Surname><\/author><\/Authorgroup>$9/) {
    	print "Author Count 3\n" if ($debug);
    	
  	  print "SNM FullGNM, FullGNM GNM. SNM, and FullGNM\-FullGNM SNM\n" if ($debug);
    } elsif($line =~ s/^((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+ (?:[A-Z]\.|[A-Z]\.\-[A-Z]\.|[A-Z]\.[A-Z]\.))\, ([A-Z][a-z]+) ((?:Mc|Mac)?[A-Z][a-z]+)(\,? and )([A-Z][a-z]+\-[A-Z][a-z]+) ([A-Z][a-z]+)(\,? )/<Authorgroup><author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author>\, <author><Forename>$3<\/Forename> <Surname>$4<\/Surname><\/author>$5<author><Forename>$6<\/Forename> <Surname>$7<\/Surname><\/author><\/Authorgroup>$8/) {
    	print "Author Count 3\n" if ($debug);
    	
  	  print "SNM FullGNM GNM., FullGNM SNM, and FullGNM\-FullGNM SNM\n" if ($debug);
    } elsif($line =~ s/^((?:Mc|Mac)?[A-Z][a-z]+)\, ((?:[A-Z]\.|[A-Z]\.\-[A-Z]\.|[A-Z]\.[A-Z]\.) [A-Z][a-z]+)\, ([A-Z][a-z]+) ((?:Mc|Mac)?[A-Z][a-z]+)(\,? and )([A-Z][a-z]+ (?:[A-Z]\.|[A-Z]\.\-[A-Z]\.|[A-Z]\.[A-Z]\.)) ([A-Z][a-z]+)(\,? )/<Authorgroup><author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author>\, <author><Forename>$3<\/Forename> <Surname>$4<\/Surname><\/author>$5<author><Forename>$6<\/Forename> <Surname>$7<\/Surname><\/author><\/Authorgroup>$8/) {
    	print "Author Count 3\n" if ($debug);
    	
  	  print "SNM FullGNM GNM., FullGNM SNM, and FullGNM GNM. SNM\n" if ($debug);
    } elsif($line =~ s/^((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+)\, ([A-Z][a-z]+ $Agivenname) ((?:Mc|Mac)?[A-Z][a-z]+)(\,? and )([A-Z][a-z]+ (?:[A-Z]\.|[A-Z]\.\-[A-Z]\.|[A-Z]\.[A-Z]\.)) ([A-Z][a-z]+)(\,? )/<Authorgroup><author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author>\, <author><Forename>$3<\/Forename> <Surname>$5<\/Surname><\/author>$6<author><Forename>$7<\/Forename> <Surname>$8<\/Surname><\/author><\/Authorgroup>$9/) {
    	print "Author Count 3\n" if ($debug);
    	
  	  print "SNM FullGNM, FullGNM GNM. SNM, and FullGNM GNM. SNM\n" if ($debug);
    } elsif($line =~ s/^((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+ (?:[A-Z]\.|[A-Z]\.\-[A-Z]\.|[A-Z]\.[A-Z]\.))\, ([A-Z][a-z]+ (?:[A-Z]\.|[A-Z]\.\-[A-Z]\.|[A-Z]\.[A-Z]\.)) ((?:Mc|Mac)?[A-Z][a-z]+)(\, and )([A-Z][a-z]+) ((?:Mc|Mac)?[A-Z][a-z]+\-[A-Z][a-z]+)(\,? )/<Authorgroup><author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author>\, <author><Forename>$3<\/Forename> <Surname>$4<\/Surname><\/author>$5<author><Forename>$6<\/Forename> <Surname>$7<\/Surname><\/author><\/Authorgroup>$8/) {
    	print "Author Count 3\n" if ($debug);
    	
  	  print "SNM FullGNM GNM., FullGNM GNM. SNM, and FullGNM SNM-SNM\n" if ($debug);
    } elsif($line =~ s/^((?:Mc|Mac)?[A-Z][a-z]+\-[A-Z][a-z]+)\, ([A-Z][a-z]+)\, ((?:Mc|Mac)?[A-Z][a-z]+) ([A-Z][a-z]+)(\, and )([A-Z][a-z]+ (?:[A-Z]\.|[A-Z]\.\-[A-Z]\.|[A-Z]\.[A-Z]\.)) ([A-Z][a-z]+)(\,? )/<Authorgroup><author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author>\, <author><Forename>$3<\/Forename> <Surname>$4<\/Surname><\/author>$5<author><Forename>$6<\/Forename> <Surname>$7<\/Surname><\/author><\/Authorgroup>$8/) {
    	print "Author Count 3\n" if ($debug);
    	
  	  print "SNM FullGNM, FullGNM SNM, and FullGNM GNM. SNM\n" if ($debug);
    } elsif($line =~ s/^((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+ $Agivenname)\, ((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+ $Agivenname)(\,? and )([A-Z][a-z]+)\, ([A-Z][a-z]+ (?:[A-Z]\.|[A-Z]\.\-[A-Z]\.|[A-Z]\.[A-Z]\.))(\,? )/<Authorgroup><author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author>\, <author><Surname>$4<\/Surname>\, <Forename>$5<\/Forename><\/author>$7<author><Surname>$8<\/Surname>\, <Forename>$9<\/Forename><\/author><\/Authorgroup>$10/) {
    	print "Author Count 3\n" if ($debug);
    	
  	  print "SNM FullGNM GNM., SNM FullGNM GNM., and SNM FullGNM GNM.\n" if ($debug);
    } elsif($line =~ s/^((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+ $Agivenname)\, ((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+ $Agivenname)\, ([A-Z][a-z]+)\, ([A-Z][a-z]+ (?:[A-Z]\.|[A-Z]\.\-[A-Z]\.|[A-Z]\.[A-Z]\.))(\,? )/<Authorgroup><author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author>\, <author><Surname>$4<\/Surname>\, <Forename>$5<\/Forename><\/author>\, <author><Surname>$7<\/Surname>\, <Forename>$8<\/Forename><\/author><\/Authorgroup>$9/) {
    	print "Author Count 3\n" if ($debug);
    	
  	  print "SNM FullGNM GNM., SNM FullGNM GNM., SNM FullGNM GNM.\n" if ($debug);
    } elsif($line =~ s/^([A-Z][a-z]+) ([A-Z][a-z]+)\, ([A-Z][a-z]+) ([A-Z][a-z]+)\, ([A-Z][a-z]+) ([A-Z][a-z]+)\, /<Authorgroup><author><Forename>$1<\/Forename> <Surname>$2<\/Surname><\/author>\, <author><Forename>$3<\/Forename> <Surname>$4<\/Surname><\/author>\, <author><Forename>$5<\/Forename> <Surname>$6<\/Surname><\/author><\/Authorgroup>\, /) {
    	print "Author Count 3\n" if ($debug);
    	
  	  print "FullGNM SNM, FullGNM SNM, FullGNM SNM\,\n" if ($debug);
    } elsif($line =~ s/^((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+)(\,? and )([A-Z][a-z]+ (?:[A-Z]\.|[A-Z]\.\-[A-Z]\.|[A-Z]\.[A-Z]\.)) ([A-Z][a-z]+)(\,? )/<Authorgroup><author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author>$3<author><Forename>$4<\/Forename> <Surname>$5<\/Surname><\/author><\/Authorgroup>$6/) {
    	print "Author Count 3\n" if ($debug);
    	
  	  print "SNM FullGNM, and FullGNM GNM. SNM \n" if ($debug);
    } elsif($line =~ s/^((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+ $Agivenname)(\,? and )([A-Z][a-z]+)\, ([A-Z][a-z]+ (?:[A-Z]\.|[A-Z]\.\-[A-Z]\.|[A-Z]\.[A-Z]\.))(\,? )/<Authorgroup><author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author>$4<author><Surname>$5<\/Surname>\, <Forename>$6<\/Forename><\/author><\/Authorgroup>$7/) {
    	print "Author Count 2\n" if ($debug);
    	
  	  print "SNM FullGNM GNM., and SNM FullGNM GNM.\n" if ($debug);
    } elsif($line =~ s/^((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+ $Agivenname)(\,? and )([A-Z][a-z]+ (?:[A-Z]\.|[A-Z]\.\-[A-Z]\.|[A-Z]\.[A-Z]\.)) ([A-Z][a-z]+)(\,? )/<Authorgroup><author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author>$4<author><Forename>$5<\/Forename><Surname>$6<\/Surname><\/author><\/Authorgroup>$7/) {
    	print "Author Count 2\n" if ($debug);
    	
  	  print "SNM FullGNM GNM., and FullGNM GNM. SNM\n" if ($debug);
    } elsif($line =~ s/^((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+ $Agivenname)(\,? and )([A-Z][a-z]+)\, ((?:[A-Z]\.|[A-Z]\.\-[A-Z]\.|[A-Z]\.[A-Z]\.))(\,? )/<Authorgroup><author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author>$4<author><Surname>$5<\/Surname>\, <Forename>$6<\/Forename><\/author><\/Authorgroup>$7/) {
    	print "Author Count 2\n" if ($debug);
    	
  	  print "SNM FullGNM GNM., and SNM GNM.\n" if ($debug);
    } elsif($line =~ s/^((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+)(\,? and )((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+ (?:[A-Z]\.|[A-Z]\.\-[A-Z]\.|[A-Z]\.[A-Z]\.)) /<Authorgroup><author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author>$3<author><Surname>$4<\/Surname>\, <Forename>$5<\/Forename><\/author><\/Authorgroup> /) {
    	print "Author Count 2\n" if ($debug);
    	
  	  print "SNM, FullGNM, and SNM, FullGNM GNM. \&ldquo\;\n" if ($debug);
    } elsif($line =~ s/^((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+)(\,? and )((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+\.) \&ldquo\;/<Authorgroup><author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author>$3<author><Surname>$4<\/Surname>\, <Forename>$5<\/Forename><\/author><\/Authorgroup> \&ldquo\;/) {
    	print "Author Count 2\n" if ($debug);
    	
  	  print "SNM, FullGNM, and SNM, FullGNM. \&ldquo\;\n" if ($debug);
    } elsif($line =~ s/^((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+)(\,? and )((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+\.) /<Authorgroup><author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author>$3<author><Surname>$4<\/Surname>\, <Forename>$5<\/Forename><\/author><\/Authorgroup> /) {
    	print "Author Count 2\n" if ($debug);
  	  ...
  	  print "SNM FullGNM GNM., and SNM GNM\n" if ($debug);
    } elsif($line =~ s/^((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+ (?:[A-Z]\.|[A-Z]\.\-[A-Z]\.|[A-Z]\. ?[A-Z]\.))(\,? )/<Authorgroup><author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author><\/Authorgroup>$3/) {
    	print "Author Count 1\n" if ($debug);
    	
  	  print "SNM FullGNM GNM.\n" if ($debug);
    } elsif($line =~ s/^((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+)( [Ee]t a[lL]\. )/<Authorgroup><author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author><\/Authorgroup>$3/) {
    	print "Author Count 1\n" if ($debug);
    	
  	  print "SNM FullGNM. Etal\n" if ($debug);
    } elsif($line =~ s/^((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z]\. [A-Z][a-z]+\.) \&ldquo\;/<Authorgroup><author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author><\/Authorgroup> \&ldquo\;/) {
    	print "Author Count 1\n" if ($debug);
    	
  	  print "SNM GNM. FullGNM.\n" if ($debug);
    } elsif($line =~ s/^((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+)\, \&ldquo\;/<Authorgroup><author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author><\/Authorgroup>\, \&ldquo\;/) {
    	print "Author Count 1\n" if ($debug);
    	
  	  print "SNM FullGNM, \&ldquo\;\n" if ($debug);
    } elsif($line =~ s/^((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+\.) /<Authorgroup><author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author><\/Authorgroup> /) {
    	print "Author Count 1\n" if ($debug);
...
sub nameConvert
{
    ...
    if ($line =~ m/<Authorgroup>(.*?)<\/Authorgroup>/ && $line !~ m/<Surname>/) {
      ...
      if ($authorgroup =~ m/^$surname\, $givenname$/) {
        ...
        $authorgroup =~ s/^$surname\, $givenname$/<author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author>/;
        #print $authorgroup,"\n";
        ...
        $authorgroup =~ s/^$surname\, $givenname(\,? )$suffix$/<author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename>$3<Suffix>$4<\/Suffix><\/author>/;
      } elsif ($authorgroup =~ m/^$surname\, $suffix\, $givenname$/) {
      	print "Individual Aut 4\n" if($debug);
        $authorgroup =~ s/^$surname\, $suffix\, $givenname$/<author><Surname>$1<\/Surname>\, <Suffix>$2<\/Suffix>\, <Forename>$3<\/Forename><\/author>/;
      } elsif ($authorgroup =~ m/^$surname\, $givenname (et\.? al\.)$/) {
      	print "Individual Aut 5\n" if($debug);
        $authorgroup =~ s/^$surname\, $givenname (et\.? al\.)$/<author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename> <Etal>$3<\/Etal><\/author>/;
      } elsif ($authorgroup =~ m/^$surname\, $givenname\, (et\.? al\.)$/) {
      	print "Individual Aut 6\n" if($debug);
        $authorgroup =~ s/^$surname\, $givenname\, (et\.? al\.)$/<author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename>\, <Etal>$3<\/Etal><\/author>/;
      } elsif ($authorgroup =~ m/^$givenname $surname (et\.? al\.)$/) {
      	print "Individual Aut 7\n" if($debug);
        $authorgroup =~ s/^$givenname $surname (et\.? al\.)$/<author><Forename>$1<\/Forename> <Surname>$2<\/Surname> <Etal>$3<\/Etal><\/author>/;
      } elsif ($authorgroup =~ m/^$surname $givenname\, (et\.? al\.)$/) {
        ...
        $authorgroup =~ s/^$surname(\,? )$givenname([\,]? (?:[Aa]nd|XXXampXXX) )$surname(\,? )$givenname(\,? )$suffix$/<author><Surname>$1<\/Surname>$2<Forename>$3<\/Forename><\/author>$4<author><Surname>$5<\/Surname>$6<Forename>$7<\/Forename>$8<Suffix>$9<\/Suffix><\/author>/;
      } elsif ($authorgroup =~ m/^$surname\, $givenname([\,]?) (?:[Aa]nd|XXXampXXX) $surname $suffix\, $givenname$/) {
      	print "Individual Aut 12\n" if($debug);
        $authorgroup =~ s/^$surname\, $givenname([\,]?) ([Aa]nd|XXXampXXX) $surname $suffix\, $givenname$/<author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author>$3 $4 <author><Surname>$5<\/Surname> <Suffix>$6<\/Suffix>\, <Forename>$7<\/Forename><\/author>/;
      } elsif ($authorgroup =~ m/^$surname\, $givenname([\,]?) (?:[Aa]nd|XXXampXXX) $surname\, $givenname$/) {
      	print "Individual Aut 13\n" if($debug);
        $authorgroup =~ s/^$surname\, $givenname([\,]?) ([Aa]nd|XXXampXXX) $surname\, $givenname$/<author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author>$3 $4 <author><Surname>$5<\/Surname>\, <Forename>$6<\/Forename><\/author>/;
      } elsif ($authorgroup =~ m/^$surname $givenname\, ([Aa]nd|XXXampXXX) $surname\, $givenname$/) {
      	print "Individual Aut 14\n" if($debug);
        $authorgroup =~ s/^$surname $givenname\, ([Aa]nd|XXXampXXX) $surname\, $givenname$/<author><Surname>$1<\/Surname> <Forename>$2<\/Forename><\/author>\, $3 <author><Surname>$4<\/Surname>\, <Forename>$5<\/Forename><\/author>/;
      } elsif ($authorgroup =~ m/^$surname $givenname\, ([Aa]nd|XXXampXXX) $surname $givenname$/) {
      	print "Individual Aut 15\n" if($debug);
        $authorgroup =~ s/^$surname $givenname\, ([Aa]nd|XXXampXXX) $surname $givenname$/<author><Surname>$1<\/Surname> <Forename>$2<\/Forename><\/author>\, $3 <author><Surname>$4<\/Surname> <Forename>$5<\/Forename><\/author>/;
      } elsif ($authorgroup =~ m/^$surname\, $givenname\, $surname $givenname$/) {
      	print "Individual Aut 16\n" if($debug);
        $authorgroup =~ s/^$surname\, $givenname\, $surname $givenname$/<author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author>\, and <author><Surname>$3<\/Surname>\, <Forename>$4<\/Forename><\/author>/;
      } elsif($authorgroup =~ s/^((?:Mc|Mac)?[A-Z][a-z]+)\, ([A-Z][a-z]+)( [Ee]t a[lL]\.?)/<author><Surname>$1<\/Surname>\, <Forename>$2<\/Forename><\/author>$3/) {
        ...
        $authorgroup =~ s/(.*)/<Collab>$1<\/Collab>/;
      } elsif ($authorgroup =~ m/^($surname\, $givenname[\,\;] |$surname\,? $suffix\, $givenname\, |$surname\,? $suffix\, $givenname|$surname\, $givenname&comma; $suffix\, )/) {
        my $temp = '';
      ...
      $authorgroup =~ s/<author>([\,\;] | [Aa]nd |&comma; [Aa]nd |\,)/$1<author>/g;
...
#print $line,"\n\n";
	...
	#print $editorgroup,"\n";
      if ($editorgroup =~ m/^$surname\, $Agivenname$/) {
        $editorgroup =~ s/^$surname\, $Agivenname$/<editor><ESurname>$1<\/ESurname>\, <EForename>$2<\/EForename><\/editor>/;
      } elsif ($editorgroup =~ m/^$surname $givenname$/) {
        $editorgroup =~ s/^$surname $givenname$/<editor><ESurname>$1<\/ESurname> <EForename>$2<\/EForename><\/editor>/;
      } elsif ($editorgroup =~ m/^$surname\, $givenname\,? $suffix$/) {
        $editorgroup =~ s/^$surname\, $givenname(\,? )$suffix$/<editor><ESurname>$1<\/ESurname>\, <EForename>$2<\/EForename>$3<Suffix>$4<\/Suffix><\/editor>/;
      } elsif ($editorgroup =~ m/^$surname\, $suffix\, $givenname$/) {
        $editorgroup =~ s/^$surname\, $suffix\, $givenname$/<editor><ESurname>$1<\/ESurname>\, <Suffix>$2<\/Suffix>\, <EForename>$3<\/EForename><\/editor>/;
      } elsif ($editorgroup =~ m/^$surname\, $givenname\, (et\.? al\.)$/) {
        $editorgroup =~ s/^$surname\, $givenname\, (et\.? al\.)$/<editor><ESurname>$1<\/ESurname>\, <EForename>$2<\/EForename>\, <Etal>$3<\/Etal><\/editor>/;
      } elsif ($editorgroup =~ m/^$surname $givenname\, (et\.? al\.)$/) {
        $editorgroup =~ s/^$surname $givenname\, (et\.? al\.)$/<editor><ESurname>$1<\/ESurname> <EForename>$2<\/EForename>\, <Etal>$3<\/Etal><\/editor>/;
      } elsif ($editorgroup =~ m/^$surname\, $givenname (et\.? al\.)$/) {
        $editorgroup =~ s/^$surname\, $givenname (et\.? al\.)$/<editor><ESurname>$1<\/ESurname>\, <EForename>$2<\/EForename> <Etal>$3<\/Etal><\/editor>/;
      } elsif ($editorgroup =~ m/^$surname\, $givenname([\,]?) [Aa]nd $surname $suffix\, $givenname$/) {
        $editorgroup =~ s/^$surname\, $givenname([\,]?) [Aa]nd $surname $suffix\, $givenname$/<editor><ESurname>$1<\/ESurname>\, <EForename>$2<\/EForename><\/editor>$3 and <editor><ESurname>$4<\/ESurname> <Suffix>$5<\/Suffix>\, <EForename>$6<\/EForename><\/editor>/;
      } elsif ($editorgroup =~ m/^$surname\, $givenname([\,]?) [Aa]nd $surname\, $givenname$/) {
        $editorgroup =~ s/^$surname\, $givenname([\,]?) [Aa]nd $surname\, $givenname$/<editor><ESurname>$1<\/ESurname>\, <EForename>$2<\/EForename><\/editor>$3 and <editor><ESurname>$4<\/ESurname>\, <EForename>$5<\/EForename><\/editor>/;
      } elsif ($editorgroup =~ m/^$surname $givenname\, [Aa]nd $surname\, $givenname$/) {
        $editorgroup =~ s/^$surname $givenname\, [Aa]nd $surname\, $givenname$/<editor><ESurname>$1<\/ESurname>\, <EForename>$2<\/EForename><\/editor>\, and <editor><ESurname>$3<\/ESurname>\, <EForename>$4<\/EForename><\/editor>/;
        ...
        $editorgroup =~ s/(.*)/<Collab>$1<\/Collab>/;
      } elsif ($editorgroup =~ m/^($surname\, $givenname[\,\;] |$surname\,? $suffix\, $givenname\, |$surname\,? $suffix\, $givenname|$surname\, $givenname&comma; $suffix\, |$surname\, $givenname)/) {
        my $temp = '';
